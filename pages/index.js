...
const styles = {
  ...
  header: {
    ...
    padding: "1rem 2rem", borderBottom: "1px solid rgba(0,0,0,0.07)",
    background: "rgba(250,250,248,0.9)", backdropFilter: "blur(10px)",
    position: "sticky", top: 0, zIndex: 100,
  },
  logo: { display: "flex", alignItems: "center", gap: "10px" },
  logoMark: { fontSize: "24px", color: "#d4a843" },
  logoText: { fontFamily: "Syne, sans-serif", fontSize: "20px", fontWeight: 700, color: "#0f0f0f" },
  ...
  heroTitle: { fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, lineHeight: 1.15, color: "#0f0f0f", marginBottom: "0.75rem" },
  heroSub: { fontSize: "16px", color: "#6b6b6b", maxWidth: "480px", margin: "0 auto" },
  ...
  modeBtn: {
    ...
    border: "1px solid rgba(0,0,0,0.1)", background: "#f2f1ed", color: "#3a3a3a",
    fontFamily: "DM Sans, sans-serif", transition: "all 0.15s", textAlign: "left",
  },
  modeBtnActive: { background: "#0f0f0f", color: "white", border: "1px solid #0f0f0f" },
  toneRow: { display: "flex", flexWrap: "wrap", gap: "6px" },
  toneBtn: {
    padding: "5px 12px", borderRadius: "20px", fontSize: "13px", cursor: "pointer",
    border: "1px solid rgba(0,0,0,0.1)", background: "transparent", color: "#6b6b6b", transition: "all 0.15s",
  },
  toneBtnActive: { background: "#d4a843", color: "white", border: "1px solid #d4a843" },
  textarea: {
    width: "100%", padding: "1rem", borderRadius: "10px", border: "1px solid rgba(0,0,0,0.12)",
    background: "white", fontSize: "15px", lineHeight: 1.6, color: "#0f0f0f",
  ...
  outputBox: {
    minHeight: "200px", borderRadius: "10px", border: "1px solid rgba(0,0,0,0.1)",
    background: "#f2f1ed", padding: "1.25rem", display: "flex", alignItems: "center", justifyContent: "center",
  },
  outputBoxFilled: { background: "white", alignItems: "flex-start", animation: "fadeIn 0.3s ease" },
  ...
  outputText: { fontSize: "15px", lineHeight: 1.75, color: "#0f0f0f", whiteSpace: "pre-wrap" },
  errorText: { fontSize: "14px", color: "#c0392b" },
  historyList: { display: "flex", flexDirection: "column", gap: "6px" },
  historyItem: {
    display: "flex", alignItems: "center", gap: "10px", padding: "8px 12px",
    borderRadius: "8px", background: "#f2f1ed", cursor: "pointer", transition: "background 0.15s",
  },
  ...
  pricingCard: { background: "#fafaf8", borderRadius: "12px", padding: "1.5rem", border: "1px solid rgba(0,0,0,0.08)" },
