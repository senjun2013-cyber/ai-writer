...
const styles = {
  ...
  header: {
    ...
    padding: "1rem 2rem", borderBottom: "1px solid rgba(221,180,140,0.12)",
    background: "rgba(10, 9, 8, 0.48)", backdropFilter: "blur(20px)",
    position: "sticky", top: 0, zIndex: 100,
  },
  logo: { display: "flex", alignItems: "center", gap: "10px" },
  logoMark: { fontSize: "24px", color: "#ddb48c" },
  logoText: { fontFamily: "Syne, sans-serif", fontSize: "20px", fontWeight: 700, color: "#f5f0e8" },
  headerRight: { display: "flex", alignItems: "center", gap: "12px" },
  usageBadge: { fontSize: "13px", color: "#e8d4b8", background: "rgba(255,255,255,0.08)", padding: "4px 10px", borderRadius: "20px" },
  proBadge: { fontSize: "12px", fontWeight: 700, color: "#0a0a08", background: "rgba(221,180,140,0.18)", padding: "4px 10px", borderRadius: "20px", border: "1px solid rgba(221,180,140,0.55)" },
  btnGold: {
    background: "#ddb48c", color: "#0a0a08", border: "none", borderRadius: "8px",
    padding: "8px 16px", fontSize: "13px", fontWeight: 600, cursor: "pointer", fontFamily: "Syne, sans-serif",
  },
  btnOutline: {
    background: "transparent", color: "#ddb48c", border: "1px solid #ddb48c", borderRadius: "8px",
  ...
  heroTitle: { fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, lineHeight: 1.15, color: "#f5f0e8", marginBottom: "0.75rem" },
  heroSub: { fontSize: "16px", color: "#d4c5b0", maxWidth: "480px", margin: "0 auto" },
  ...
  modeBtn: {
    ...
    border: "1px solid rgba(221,180,140,0.14)", background: "rgba(255,255,255,0.12)", color: "#f3eddb",
    fontFamily: "DM Sans, sans-serif", transition: "all 0.15s", textAlign: "left",
  },
  modeBtnActive: { background: "rgba(221,180,140,0.20)", color: "#0a0a08", border: "1px solid rgba(221,180,140,0.9)" },
  toneRow: { display: "flex", flexWrap: "wrap", gap: "6px" },
  toneBtn: {
    padding: "5px 12px", borderRadius: "20px", fontSize: "13px", cursor: "pointer",
    border: "1px solid rgba(221,180,140,0.18)", background: "rgba(255,255,255,0.09)", color: "#f0e9d7", transition: "all 0.15s",
  },
  toneBtnActive: { background: "rgba(221,180,140,0.20)", color: "#0a0a08", border: "1px solid rgba(221,180,140,0.95)" },
  textarea: {
  ...
  outputBox: {
    minHeight: "200px", borderRadius: "10px", border: "1px solid rgba(221,180,140,0.18)",
    background: "rgba(10, 8, 6, 0.82)", padding: "1.25rem", display: "flex", alignItems: "center", justifyContent: "center",
  },
  outputBoxFilled: { background: "rgba(12, 10, 8, 0.88)", alignItems: "flex-start", animation: "fadeIn 0.3s ease" },
  emptyState: { textAlign: "center" },
  emptyIcon: { fontSize: "32px", color: "#ddb48c", display: "block", marginBottom: "8px" },
  ...
  loadingFill: { height: "100%", background: "#ddb48c", animation: "loadingSlide 2s ease-out forwards" },
  loadingText: { fontSize: "14px", color: "#6b6b6b" },
  outputText: { fontSize: "15px", lineHeight: 1.75, color: "#f0e7cf", whiteSpace: "pre-wrap" },
  errorText: { fontSize: "14px", color: "#ffb3a7" },
  historyList: { display: "flex", flexDirection: "column", gap: "6px" },
  historyItem: {
    display: "flex", alignItems: "center", gap: "10px", padding: "8px 12px",
    borderRadius: "8px", background: "rgba(255,255,255,0.08)", cursor: "pointer", transition: "background 0.15s",
  },
  historyMode: { fontSize: "11px", fontWeight: 600, color: "#ddb48c", textTransform: "uppercase", minWidth: "60px" },
  ...
  modalIcon: { fontSize: "40px", color: "#ddb48c", textAlign: "center", marginBottom: "0.75rem" },
  modalTitle: { fontSize: "24px", fontWeight: 800, textAlign: "center", marginBottom: "0.5rem" },
  modalDesc: { fontSize: "14px", color: "#aab8c8", textAlign: "center", marginBottom: "1.5rem" },
  ...
  price: { fontSize: "48px", fontWeight: 800, fontFamily: "Syne, sans-serif", color: "#ddb48c" },
  ...
  btnUpgrade: {
    width: "100%", padding: "14px", background: "#ddb48c", color: "#0a0a08", border: "none",
